  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        ...
        <Link to="/negocio/dashboard" className="text-sm text-primary hover:underline">
          Ya tengo cuenta
        </Link>
      </header>
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 lg:grid-cols-2 lg:items-start">
        <div>
          <span className="badge-dot badge-new">
            <Building2 className="h-3 w-3" /> Para casas de empeño
          </span>
          <h1 className="mt-4 font-display text-4xl font-extrabold uppercase leading-tight md:text-5xl">
            Recibe solicitudes y haz <span className="text-primary">más ofertas</span> sin que el
            cliente venga primero al local.
          </h1>
          <p className="mt-4 max-w-md text-muted-foreground">
            Conecta tu negocio a una red de clientes calificados. Tú defines monto, tasa y plazo.
            EMPEÑALO se encarga del resto.
          </p>

          <div className="mt-8 space-y-4">
            {[
              {
                t: "Sin tasaciones de la plataforma",
                d: "Tú defines la propuesta basada en lo que ves.",
              },
