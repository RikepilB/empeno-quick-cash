      ...
      <div className="flex min-h-[680px] flex-col bg-gradient-to-b from-surface to-background p-6">
        ...
        <div className="mt-12 flex-1">
          <h1 className="font-display text-4xl font-extrabold uppercase leading-[0.95]">
            Empeña tu artículo y recibe ofertas de <span className="text-primary">múltiples casas de empeño</span> en minutos.
          </h1>
          ...
          <div className="mt-8 space-y-3">
            {[
              ...
              { n: "2", t: "Recibir ofertas", d: "Las casas de empeño te proponen monto, tasa y plazo." },
              { n: "3", t: "Elegir y cobrar", d: "Acepta una y recibe tu código único." },
            ].map((s) => (
              <div key={s.n} className="flex items-start gap-3 rounded-xl border border-border bg-surface p-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary/15 font-display text-lg font-bold text-primary">{s.n}</div>
                <div>
        ...
        <div className="space-y-3 pt-8">
          ...
          <Link to="/app/register" className="btn-ghost w-full">Crear cuenta nueva</Link>
